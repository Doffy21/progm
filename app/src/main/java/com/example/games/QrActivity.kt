...
class QrActivity : AppCompatActivity() {
    ...
    private fun validateAnswer() {
        ...
        if (userInput == currentAnswer) {
            ...
            mediaPlayer = MediaPlayer.create(this@QrActivity, R.raw.success)
            mediaPlayer?.start()
        } else {
            multiplier = 1
            multiplierText.text = "x$multiplier"
            feedbackText.text = "${getString(R.string.wrong)} It was : $currentAnswer"
            mediaPlayer = MediaPlayer.create(this@QrActivity, R.raw.fail)
            mediaPlayer?.start()
        }
    ...
    private fun startTimer() {
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                mediaPlayer = MediaPlayer.create(this@QrActivity, R.raw.tada)
                mediaPlayer?.start()
            }
        }
